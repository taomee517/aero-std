...
//    private String desc;
//
//    ParamCode(int code, String desc){
//        this.code = code;
//        this.desc = desc;
//    }
//
//    private static Map<Integer, ParamCode> CODE_MAP = new HashMap<>();
//
//    static {
//        ParamCode[] types = values();
//        for(ParamCode type: types){
//            CODE_MAP.put(type.getCode(),type);
//        }
//    }
//
//    public static ParamCode getFunctionType(int code){
